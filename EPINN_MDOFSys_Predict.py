...
def main() -> None:
    ...
    if isinstance(checkpoint.get("input_increment_scale"), (list, tuple)):
        raise ValueError("Use EPINN_MDOFSys_Test.py --variant increment for per-DOF scale checkpoints.")
