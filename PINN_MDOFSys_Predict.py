"""Predict the 100 held-out samples with a trained conventional PINN."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output",
        type=Path,
        default=Path("DataSet/PINN/Outputs/MDOFSys_Wave_PINN.mat"),
    )
...
def main() -> None:
    ...
    print(f"Saved PINN predictions to {args.output.resolve()}")
